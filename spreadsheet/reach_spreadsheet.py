...
def testCreateTimeManagementReport():
    ...
    ss.prepare_setCellStringFormatterormat("H4:H%d" % (rowCount2 + 3), {"numberFormat": {'pattern': '[h]:mm:ss', 'type': 'TIME'}}, fields = "userEnteredFormat.numberFormat")  # Duration number format for H4:H* column
